...
const COORDS = {
  ...
  mazotos:[34.745,33.49], fromentine:[46.89,-2.15],
  // ada-bojana: bewusst NICHT aufgenommen — ERA5 verfehlt die lokale Maestral-Thermik (zeigt im Sommer ~1 %); windChart ist kuratiert
};
